            ...
            if(args.length <= 0)
            {
                (async () => {
                    ...
                    let urls1 = await page.evaluate(() => {
                        table = document.querySelector('html body div.main-container div.resizable-container div.page main div#content div #mw-content-text div.mw-parser-output table:nth-child(1) tbody tr').textContent
                        console.log(table)
